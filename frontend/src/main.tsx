...
const viewIds: readonly ViewId[] = ["overview", "models", "flows", "skills", "access", "activity", "settings"];
const requestedView = query?.get("view");
const initialView: ViewId = viewIds.find((view) => view === requestedView) ?? "overview";
const themeStorage = (() => {
