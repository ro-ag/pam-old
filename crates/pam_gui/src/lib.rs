...
pub use desktop::{
    ...
    ConnectorSummaryDto, ConnectorTestDto, ConnectorsDto, CurrentDto, DesktopCore, DesktopErrorDto,
    DesktopErrorKind, DesktopResult, EvidenceDataDto, EvidenceDto, EvidenceHandleDto, FailureDto,
