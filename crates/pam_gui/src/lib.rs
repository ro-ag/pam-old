...
pub use desktop::{
    ...
    ActivityDayDto, ConnectorSummaryDto, ConnectorTestDto, ConnectorsDto, CurrentDto,
    DaemonLogEntryDto, DaemonLogsDto, DaemonStatsDto, DesktopCore, DesktopErrorDto,
    DesktopErrorKind, DesktopResult, EvidenceDataDto,
