...
pub fn run() -> Result<(), Box<dyn Error>> {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::daemon_startup_progress,
            ...
            commands::daemon_access,
            commands::daemon_access_config,
            commands::set_daemon_access,
            commands::model_status,
            commands::model_infer,
            commands::model_import,
            commands::model_load,
            commands::model_unload,
            commands::model_unregister,
            commands::model_verify,
            commands::model_sweep,
            commands::model_delete_weights,
            ...
            commands::settings_set_default_model,
            commands::logs_delete,
            commands::reset_access,
            ...
            commands::open_flow,
            commands::flow_run,
            commands::flow_run_progress,
            commands::flow_run_cancel,
            commands::flow_run_history,
